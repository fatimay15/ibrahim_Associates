                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><a target="_blank" href="<?php echo $row['image']?>"><?php if ($row['image'] != "images/"): ?><?php  echo "<img src='".$row['image']."' height='50' width='50' >"?><?php endif; ?></a></td>
                      <td><?php  echo $row['is_paid'];?></td>
                      <td>
                      <a href="update-expense.php?id=<?php echo $row['id']?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                      <a href="manage-expense.php?delid=<?php echo $row['id'];?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                    </td>
                    </tr>
                    <?php
                      $cnt=$cnt+1;
