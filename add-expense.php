...
if(strlen($_SESSION['detsuid']==0)):
    ...
    if(isset($_POST['submit'])) {
        ...
        $query = mysqli_query($conn, "INSERT INTO tblexpenses(user_id, expense_date, expense_item, cost,paid_by,image,is_paid) VALUES ('$userid', '$exdate', '$item', '$itemcost', '$paid_by','$folder','$itempaid')");
        if($query) {
                            ...
                            <form role="form" method="post" enctype="multipart/form-data">
                                <fieldset>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label>Paid</label>
                                        <select class="form-select form-select-lg mb-3 form-control required"  name="is_paid">
